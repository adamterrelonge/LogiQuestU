...
const RegisterScreen = ({ navigation }) => {
    const { signUp } = useAuth(); // 2. Pull the signUp function
    ...
    const handleRegister = async () => {
        ...
        setLoading(true);
        try {
            // 5. Call the signUp from AuthContext
            // This handles BOTH Supabase Auth and the Profile table insertion
            ...
            // Catches Supabase errors (e.g., user already exists)
...
const styles = StyleSheet.create({
    ...
    buttonDisabled: { backgroundColor: '#84cf96' }, // Added a faded green for disabled state
